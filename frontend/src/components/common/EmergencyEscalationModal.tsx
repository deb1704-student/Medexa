...
export const EmergencyEscalationModal: React.FC<EmergencyEscalationModalProps> = ({
  ...
  const [facility, setFacility] = useState("South 24 Parganas Sammilani Medical College & Hospital");
            ...
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1">
                  GPS telemetry broadcasted to nearest available ALS unit in Namkhana-South 24 Parganas zone.
                </p>
              </div>
            ...
            <>
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  >
                    <option value="South 24 Parganas Sammilani Medical College & Hospital">
                      South 24 Parganas Sammilani Medical College & Hospital (Tertiary)
                    </option>
                    <option value="Dwariknagar Rural Hospital">
                      Dwariknagar Rural Hospital (Secondary)
                    </option>
