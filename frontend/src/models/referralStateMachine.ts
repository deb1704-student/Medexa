...
export const LEGAL_TRANSITIONS: Record<ReferralStateT, ReferralStateT[]> = {
  ...
  SENT: ["RECEIVED", "ACCEPTED", "REJECTED", "EXPIRED", "EMERGENCY_ESCALATED", "REFERRED_BACK", "CLOSED"],
  RECEIVED: ["ACCEPTED", "REJECTED", "EMERGENCY_ESCALATED", "REFERRED_BACK", "CLOSED"],
  ACCEPTED: ["APPOINTMENT_QUEUED", "CONSULTED", "PATIENT_NO_SHOW", "EMERGENCY_ESCALATED", "REFERRED_BACK", "CLOSED"],
