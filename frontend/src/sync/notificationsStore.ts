...
const SEED_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    message: "Patient discharged from South 24 Parganas Hospital. Wound dressing and blood sugar home follow-up assigned to Shibpur ASHA.",
    timestamp: "10m ago",
    type: "info",
    read: false,
    patientId: "PAT-1076",
  ...
  },
  {
    id: "notif-3",
    role: "block",
    title: "New Red-Flag Referral from Namkhana Sub-Centre",
  ...
  },
  {
    ...
    message: "Diamond Harbour DH: 4 of 6 Ventilator Beds occupied. 2 Emergency Neonatal beds available.",
    timestamp: "40m ago",
    type: "info",
    read: false,
  },
