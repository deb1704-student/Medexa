...
const FALLBACK_FACILITY_OPTIONS: FacilityPathwayOption[] = [
  {
    ...
    facilityName: "Dwariknagar Rural Hospital",
    distanceKm: 3.2,
  ...
  },
  {
    ...
    facilityName: "Namkhana Block CHC",
    distanceKm: 8.5,
    serviceAvailability: "available",
    diagnosticAvailability: "available",
  ...
  },
  {
    ...
    facilityName: "Maharajganj Rural Hospital (Block CHC)",
    distanceKm: 14.1,
    serviceAvailability: "available",
  ...
  },
  {
    ...
    facilityName: "South 24 Parganas District General Hospital",
    distanceKm: 28.7,
    serviceAvailability: "available",
    diagnosticAvailability: "available",
    medicineAvailability: "available",
